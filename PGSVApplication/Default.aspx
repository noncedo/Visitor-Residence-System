<%@ Page Title="" Language="C#" MasterPageFile="~/GeneralMaster.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="PGSVApplication.Default" %>
    ...
    <div class="container">
        <div id="carousel-example-generic" class="carousel slide" style="width:100%;height:360px"margin:0 auto; data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item">
                    <img src="Images/4.jpeg" alt="..." style="width:100%;height:360px" />
                    <div class="carousel-caption">
                        <h3>PGSV</h3>
                        <p>Block B</p>
                    </div>
                ...
                <div class="item">
                    <img src="Images/1.jpg" alt="..." style="width:100%;height:360px" />
                    <div class="carousel-caption">
                        <h3>PGSV</h3>
                        <p>Block C</p>
                    </div>
                ...
                <div class="item">
                    <img src="Images/4.jpg" alt="..." style="width:100%;height:360px" />
                    <div class="carousel-caption">
                        <h3>PGSV</h3>
                        <p>Block D</p>
                    </div>
