<%@ Page Title="" Language="C#" MasterPageFile="~/SecurityMaster.Master" AutoEventWireup="true" CodeBehind="SecurityAddSpecialPermit.aspx.cs" Inherits="PGSVApplication.WebForm9" %>
        ...
        <div class="form-group col-sm-11">
            <div style="border-radius: 0px; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);" class="panel panel-primary">
                <div style="border-radius: 0px;" class="panel-heading">
                    <h3>Approved Special Permits</h3>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <asp:GridView ID="SpecialPermit" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false"
                                    OnRowEditing="SpecialPermit_RowEditing" OnPreRender="SpecialPermit_PreRender">
                                    <Columns>
                                        <asp:BoundField DataField="SleepOverId" HeaderText="Key" ShowHeader="true" Visible="false" />
                                        ...
                                        <asp:BoundField DataField="StartDate" HeaderText="Start Date" ShowHeader="true" />
                                        <asp:BoundField DataField="EndDate" HeaderText="End Date" ShowHeader="true" />
